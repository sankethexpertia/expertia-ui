...
export const Quantity = ({ children, className, ...rest })=> {

  return (
    <div className="flex items-center">
      <div
        onClick={() => rest.onValueChange((e) => e - 1)}
        className="w-8 h-8 bg-gray-200 rounded-md flex justify-center items-center shadow-md"
      >
<svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.25 7.5C2.25 7.22386 2.47386 7 2.75 7H12.25C12.5261 7 12.75 7.22386 12.75 7.5C12.75 7.77614 12.5261 8 12.25 8H2.75C2.47386 8 2.25 7.77614 2.25 7.5Z" fill="currentColor" fill-rule="evenodd" clip-rule="evenodd"></path></svg>
      ...
      <div className="w-12 h-12 shadow-md border-solid border-[1px] border-gray-200 rounded-md flex justify-center items-center">
        {rest.value}
      </div>
      <div
        onClick={() => rest.onValueChange((e) => e + 1)}
